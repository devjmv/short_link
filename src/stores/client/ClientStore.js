...
export const ClientStore = defineStore('client', () => {
  ...
  function editLink(accessToken, newLink) {
    const service = new ClientService()
    return service.editLink(accessToken, newLink)
  }
  ...
  return { currentPage, pageSize, totalPages, order, listLinksGest, getLinks, createLink, createLinkFree, addLinkGest, clearLink, changeState, editLink }
})
