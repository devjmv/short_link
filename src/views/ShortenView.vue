...
<template>
  <main>
    <div class='flex items-center justify-center min-h-screen dark:bg-bgdark'>
      <div class="flex rounded-full bg-bglight dark:bg-dark px-2 w-full max-w-[600px]">
        <button class="self-center flex p-1 cursor-pointer bg-bglight dark:bg-dark"> <svg width="30px" height="30px"
        ...
        <button type="submit" class="relative p-2 bg-bglight dark:bg-dark rounded-full">
